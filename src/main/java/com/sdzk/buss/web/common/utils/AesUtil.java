...
public class AesUtil {
    ...
    public static void main(String args [] ) throws Exception {
        ...
        String strkey = getSecretKey();
        String msg = "Token=111&dataSource=1&mineCode=1";
        System.out.println(AesUtil.toHexString(msg));
        String base64StrWithIV = AesUtil.encryptWithIV(msg, strkey);
        System.out.println("密钥"+strkey);
        System.out.println("明文:"+msg);
        System.out.println("加密后:"+base64StrWithIV);

    //    byte[] ms = new Base64().decode(base64StrWithIV);

        String str = AesUtil.decryptWithIV(base64StrWithIV, strkey);
