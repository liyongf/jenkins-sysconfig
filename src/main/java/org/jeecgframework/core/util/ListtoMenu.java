...
//		menuString.append(icon);
	...
	public static String getHplusMultistageTree(Map<Integer, List<TSFunction>> map) {
		...
		int curIndex = 0;
		for (TSFunction function : list) {
            if(function.getFunctionName().equals("安全风险分级管控")){
                menuString.append("<li id=\"aqfxfjgkLi\">");
            }else if(function.getFunctionName().equals("隐患排查治理")){
                menuString.append("<li id=\"yhpczlLi\">");
            }else if(function.getFunctionName().equals("安全标准化考核")){
                menuString.append("<li id=\"aqbzhkhLi\">");
            }else if(function.getFunctionName().equals("安全决策分析")){
                menuString.append("<li id=\"aqjcfxLi\">");
            }else if(function.getFunctionName().equals("辅助管理")){
                menuString.append("<li id=\"fzglLi\">");
            }else if(function.getFunctionName().equals("系统监控")){
                menuString.append("<li id=\"xtjkLi\">");
            }else{
                menuString.append("<li>");
            }
