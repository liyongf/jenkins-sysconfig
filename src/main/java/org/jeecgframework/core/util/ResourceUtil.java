...
//		String requestPath = request.getRequestURI() + "?" + request.getQueryString();
     ...
     * @return
     */
    public static String getRequestPathWithParams(HttpServletRequest request) {
...
//		String requestPath = request.getRequestURI() + "?" + request.getQueryString();
	 ...
	 * @return
     */
	public static String getInitParam(String field) {
		HttpServletRequest request = ContextHolderUtils.getRequest();
		return request.getServletContext().getInitParameter(field);
	}
