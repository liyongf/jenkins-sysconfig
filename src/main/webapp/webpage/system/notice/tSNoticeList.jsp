...
<div id="main_depart_list" class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tSNoticeList" checkbox="true" fitColumns="false" title="common.notice" actionUrl="noticeController.do?datagrid2" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="common.add" icon="icon-add" url="noticeController.do?goAdd" funname="add" width="800" height="600" operationCode="add"></t:dgToolBar>
   <t:dgToolBar title="common.edit" icon="icon-edit" url="noticeController.do?goUpdate" funname="update" width="800" height="600" operationCode="update"></t:dgToolBar>
   <t:dgToolBar title="common.batchDelete"  icon="icon-remove" url="noticeController.do?doBatchDel" funname="deleteALLSelect" operationCode="batchdelete"></t:dgToolBar>
