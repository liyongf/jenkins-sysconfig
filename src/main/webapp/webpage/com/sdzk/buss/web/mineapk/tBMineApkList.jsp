...
<div class="easyui-layout" fit="true">
 <div region="center" style="padding:0px;border:0px">
  <t:datagrid name="tBMineApkList" checkbox="true" pagination="true" fitColumns="true" title="矿井APK配置" actionUrl="tBMineApkController.do?datagrid&mineId=${mineId}" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="是否静默下载"  field="isSilent"  queryMode="group" dictionary="yesOrNo"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="tBMineApkController.do?goAdd&mineId=${mineId}" funname="add" height="500" width="800"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="tBMineApkController.do?goUpdate" funname="update" height="500" width="800"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="tBMineApkController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="tBMineApkController.do?goUpdate" funname="detail"  height="500" width="800"></t:dgToolBar>
